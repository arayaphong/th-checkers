...
import { Repl } from '../../src/app/Repl.js';
import { createDemo31Game } from '../../src/app/demo31.js';
import { createDemo32Game } from '../../src/app/demo32.js';
import type { Game } from '../../src/index.js';

function runRepl(inputLines: string[], game?: Game): Promise<string> {
